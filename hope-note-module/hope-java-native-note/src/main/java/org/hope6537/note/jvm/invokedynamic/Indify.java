...
public class Indify {
    public static void main(String... av) throws IOException {
        av = new String[]{
                "--overwrite",
                "/Users/hope6537/Documents/WorkSpace/hope-tactical-equipment/hope-note-module/hope-java-native-note/target/classes/org/hope6537/note/jvm/invokedynamic/InvokeDynamicExample.class"};
        new Indify().run(av);
    }
