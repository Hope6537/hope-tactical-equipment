...
var salary :Int = 200{
willSet(newValue){
    print("change the charge \(newValue)");
}
didSet(oldValue){
...
func testSetAndGetAndIndex(){
    ...
    showResult();
    print(People.staticParam);
    print(People.staticFunc());
    
    let myAssistant = Assistant();
    ...
    //注意使用!来解包
    print(myAssistant[2]!);
    print(myAssistant[32]!);
    print(myAssistant[2,31]!);
