...
public interface RequireService {
     ...
     */
    ResultSupport<Integer> addRequire(String title, String des, Integer parentId, Integer studentId, Integer teacherId, String date, String time, Integer type, String reply);
