...
public interface ParentService {
     ...
     */
    ResultSupport<Integer> addParent(ParentDto parentDto);
     ...
     */
    ResultSupport<Integer> addParent(String name, String sex, String tel, String address, String email, String password);
     ...
     * @return ResultSupport.getData = 更新行数
     */
    ResultSupport<Integer> modifyParent(ParentDto parentDto);
     ...
     * @return ResultSupport.getData = 更新行数
     */
    ResultSupport<Integer> removeParent(Integer id);
     ...
     * @return ResultSupport.getData = 更新行数
     */
    ResultSupport<Integer> batchRemoveParent(List<Integer> idList);
     ...
     */
    ResultSupport<ParentDto> getParentById(Integer id);
     ...
     */
    ResultSupport<List<ParentDto>> getParentListByIdList(List<Integer> idList);
     ...
     * @return ResultSupport.getData = 多条符合条件的数据
     */
    ResultSupport<List<ParentDto>> getParentListByQuery(ParentDto query);
}
