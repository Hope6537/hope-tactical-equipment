...
public class Cleaner extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        final Job job = Job.getInstance(conf, Cleaner.class.getSimpleName());
    ...
    static class MyMapper extends Mapper<LongWritable, Text, LongWritable, Text> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws java.io.IOException, InterruptedException {
            ...
            //过滤所有静态的资源请求
            if (url.startsWith("GET /JiChuang_OA/admin_assets") || url.startsWith("GET /JiChuang_OA/frontend_assets")) {
                return;
            }
    ...
    static class MyReducer extends Reducer<LongWritable, Text, Text, NullWritable> {
        protected void reduce(LongWritable k2, Iterable<Text> v2s, Context context) throws java.io.IOException, InterruptedException {
            for (Text v2 : v2s) {
